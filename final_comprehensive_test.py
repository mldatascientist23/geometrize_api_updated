#!/usr/bin/env python3
"""
Final Comprehensive Test Suite for Geometrize API
Tests all shapes, formats, parameters, and edge cases
"""
...
def test_api_endpoint(name, endpoint, method="GET", data=None, files=None):
...
print("=" * 80)
print("GEOMETRIZE API - FINAL COMPREHENSIVE TEST SUITE")
print("=" * 80)
print()
...
with open("/tmp/final_test_results.json", "w") as f:
    json.dump(RESULTS, f, indent=2)

# Save summary
with open("/tmp/final_test_summary.txt", "w") as f:
    f.write("=" * 80 + "\n")
    f.write("GEOMETRIZE API - FINAL TEST SUMMARY\n")
    f.write("=" * 80 + "\n\n")
...
print("   - /tmp/final_test_results.json")
print("   - /tmp/final_test_summary.txt")
